...
function Info() {
  ...
  const contenido = `<head>
                    ...
                    <body  class="fondo">
                        ...
                        <ul>
                            <li>
                                ...
                                <details>
                                    ...
                                    <article>
                                        <p class="textoComentario"> - El parametro <i class='Destacar1'>Accion</i> es obigatorio.</p>
                                        <p class="textoComentario"> - El parametro <i class='Destacar1'>ListaDeValores</i> puede omitirse si la api no requiere valores adicionales.</p>
                        ...
                        <ul>
                            <li>
                                <p><b>Fuentes Url de las Api CriptoHoy (cryptocompare.com)  </b></p>
                                <p>Listado de criptomonedas</p>
                                <p>${tab}Uri:${b}<i>"https://min-api.cryptocompare.com/data/top/mktcapfull<b class='destacar2'>?</b>limit=<b class='destacar1'>10</b><b class='destacar2'>&</b>tsym=<b class='destacar1'>USD</b>" </i>${b}
                                    <a href="https://min-api.cryptocompare.com/data/top/mktcapfull?limit=10&tsym=USD" target="_blank">Ver</a></p>
                                <p>Cotizacion de criptomonedas</p>
                                <p>${tab}Uri:${b}<i>"https://min-api.cryptocompare.com/data/pricemultifull<b class='destacar2'>?</b>fsyms=<b class='destacar1'>BTC</b><b class='destacar2'>&</b>tsyms=<b class='destacar1'>USD</b>" </i>${b}
                            ...
                            <li>
                                ...
                                <p><b>En esta lista pruedes ver el token de cada cripto junto a su nombre.  </b></p>
                            ...
                            <li>
                                ...
                                <details>
                                    ...
                                    <article>
                                        <p class="textoComentario"> - El parametro <i class='Destacar1'>Accion</i> debe ser <b class='destacar1'>CRIPTO_HOY</b>.</p>
                                        <p class="textoComentario"> - El parametro <i class='Destacar1'>ListaDeValores</i> es obligatorio para esta consulta.</p>
                        ...
                        <ul>
                            <li>
                                <p><b>Fuente Url de las Api Binance  </b></p>
                                <p>${tab}Uri:${b}<i>"https://api.binance.com/api/v3/ticker/price?symbol=BTCUSDT" </i>${b}
                                    <a href="https://api.binance.com/api/v3/ticker/price?symbol=BTCUSDT" target="_blank">Ver</a></p>
                            </li>
                            <li>
                                <p><b>Consulta por valores de las cripto en Binance </b></p>
                                ...
                                <details>
                                    <summary>Instrucciones</summary>
                                    <article>
                                        <p class="textoComentario"> - El parametro <i class='Destacar1'>Accion</i> debe ser <b class='destacar1'>BINANCE_HOY</b>.</p>
                                        <p class="textoComentario"> - El parametro <i class='Destacar1'>ListaDeValores</i> es obligatorio para esta consulta.</p>
                                        ...
                                        <p class="textoComentario">${tab}${tab} - "BTC" es el nombre corto de la cripto de la cual se desea saber su valor,</p>
                                        <p class="textoComentario">${tab}${tab} - "USDT" es la moneda de referencia en la que se devolvera el valor de la cripto.</p>
